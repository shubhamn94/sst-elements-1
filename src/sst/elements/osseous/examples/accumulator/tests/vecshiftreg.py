...
app = sst_workdir + "/src/sst/elements/osseous/examples/accumulator/tests/testbench" 
...
rtl = sst.Component("accumulator", "sstAccumulator.sstAccumulator")
rtl.addParams({
        "ExecFreq" : "1GHz",
        "maxCycles" : "10o"
	})

rtlmemmgr = rtl.setSubComponent("memmgr", "sstAccumulator.MemoryManagerSimple")
